...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb, TH3D)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "FT-i3 Mega" SHORT_BUILD_VERSION // will be shown during bootup in line 1
